  ...
  <div>
    ...
    <div class="contain">
      <!-- <div class="row">
        ...
        <label class="name" for="">&nbsp;&nbsp;操作指引</label>
      ...
      <div class="row">
        <label class="left">
          <img class="img" src="/static/images/classroom.png" alt="">
        </label>
        <label class="name" for="">&nbsp;&nbsp;小程序开发课程</label>
        <label class="right" for="">
          >
        </label>
      </div>
      ...
      <div class="row">
        ...
        <label class="name" for="">&nbsp;&nbsp;清空记录</label>
        <label class="right" for="">
          >
        </label>
      </div> -->
      ...
      <div class="row" @click="showOpinion">
        ...
        <label class="name" for="">&nbsp;&nbsp;意见反馈</label>
        <label class="right" for="">
          >
        </label>
      </div>
